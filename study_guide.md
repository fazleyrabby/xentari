...
4.  **Runtime Orchestrator (`runAgent.ts`)**: Manages the transition from deterministic AST extraction to probabilistic LLM reasoning for complex tasks.
...
### **FINAL VERDICT: FULLY DETERMINISTIC ENGINE**
Xentari has transitioned from a chat-based assistant to a mathematical code intelligence engine.
...
**Study Guide Updated: April 19, 2026**
